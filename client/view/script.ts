const players_number: number = 1;
const team1: HTMLElement | null = document.getElementById("team1");
const team2: HTMLElement | null = document.getElementById("team2");
...
if (players_number <= 2) {
    ...
    if (team1 && team2) {
        ...
        for (let i = 0; i < 2; i++) {
            const sub_team1: HTMLDivElement = document.createElement("div");
            const sub_team2: HTMLDivElement = document.createElement("div");
...
function chargePlayers(): void {
    console.log("Charge players");
    let h: HTMLCollectionOf<HTMLElement>;
    if (players_number <= 2) {
    ...
    for (let i = 0; i < h.length; i++) {
        const img_player: HTMLImageElement = document.createElement("img");
        const barra_vida: HTMLDivElement = document.createElement("div");
        const name_player: HTMLParagraphElement = document.createElement("p");
...
function chargeHabs(): void {
    const hab: NodeListOf<HTMLElement> = document.querySelectorAll(".hab");

    console.log(hab);

    for (let i = 0; i < hab.length; i++) {
        const img_hab: HTMLImageElement = document.createElement("img");
